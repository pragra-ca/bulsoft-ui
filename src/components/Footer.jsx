    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center">
              <svg width="140" height="36" viewBox="0 0 1510 394" className="h-9 w-auto text-white fill-none" xmlns="http://www.w3.org/2000/svg">
                <g>
                  ...
                  {/* Theme-aware primary text and symbol base (will render white since className contains text-white) */}
            ...
            <p className="text-sm leading-relaxed text-slate-400">
              Enterprise-grade QA and AI pipeline validation engine. Delivering continuous reliability across software, ML pipelines, and autonomous AI systems globally.
            </p>
            <div className="flex space-x-4">
              <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="text-slate-400 hover:text-sky-400 transition-colors" aria-label="LinkedIn">
                <Linkedin size={20} />
              </a>
              <a href="https://twitter.com" target="_blank" rel="noreferrer" className="text-slate-400 hover:text-sky-400 transition-colors" aria-label="Twitter">
                <Twitter size={20} />
              </a>
              <a href="https://github.com" target="_blank" rel="noreferrer" className="text-slate-400 hover:text-sky-400 transition-colors" aria-label="GitHub">
                <Github size={20} />
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-slate-400">
              <li>
                <Link href="/services/ai-agent-testing" className="text-sm hover:text-sky-400 transition-colors">
                  AI Agent Testing & Auditing
                </Link>
              </li>
              <li>
                <Link href="/services/mlops-pipeline-testing" className="text-sm hover:text-sky-400 transition-colors">
                  MLOps & LLMOps Testing
                </Link>
              </li>
              <li>
                <Link href="/services/ai-data-collection" className="text-sm hover:text-sky-400 transition-colors">
                  AI Data Collection & Curation
                </Link>
              </li>
              <li>
                <Link href="/services/enterprise-test-automation" className="text-sm hover:text-sky-400 transition-colors">
                  Enterprise Test Automation
                </Link>
              </li>
              <li>
                <Link href="/services/performance-stress-engineering" className="text-sm hover:text-sky-400 transition-colors">
                  Performance & Stress Engineering
                </Link>
              </li>
              <li>
                <Link href="/services/cybersecurity-pen-testing" className="text-sm hover:text-sky-400 transition-colors">
                  Cybersecurity & Pen Testing
                </Link>
              </li>
              <li>
                <Link href="/services/core-banking-validation" className="text-sm hover:text-sky-400 transition-colors">
                  Core Banking Validation
                </Link>
              </li>
              <li>
                <Link href="/services/tcoe-advisory" className="text-sm hover:text-sky-400 transition-colors">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-sm text-center">
          <p>&copy; {new Date().getFullYear()} Bulsoft. All rights reserved. | Quality Assurance Excellence Since 2006</p>
        </div>
      </div>
    </footer>
  );
